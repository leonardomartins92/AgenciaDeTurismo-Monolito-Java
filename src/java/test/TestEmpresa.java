...
public class TestEmpresa {
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        Empresa empresa = new Empresa("5050", "Hotel Transylvania", "hotelTransylvania@gmail.com", "505", "Rua do Hotel", "5", null, "MG", "Juiz de Fora", TipoEmpresa.ACOMODACAO, "36080001");
