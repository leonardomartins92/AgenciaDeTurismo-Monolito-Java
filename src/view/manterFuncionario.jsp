...
<div class="container">
  <div class="row align-items-start">
    ...
    <div class="col">
      <form class="row g-3">
        <h2>Cadastro de Funcionário - <%= request.getParameter("acao")%></h2>
        <div class="col-12">
        ...
        <div class="col-md-8">
          ...
          <input type="password" class="form-control" id="inputPassword" placeholder="" <%= request.getAttribute("hide")%>>
        </div>
        <div class="col-md-4">
          <label for="inputFunction" class="form-label">Função</label>
          <select id="inputFunction" class="form-select" <%= request.getAttribute("hide")%>>
